...
/////	
	...
	public void enterNumber(String number) throws InterruptedException {
		//waitForElementToAppearWithText(SignIn, driver, "Sign in");
		Thread.sleep(2000);	
...
/////	
	...
	public void setAddAddress() throws InterruptedException {
		AddAddress.click();
	}
	...
	private WebElement ChangeOne;
	@AndroidFindBy(xpath = "(//android.widget.TextView[@text=\"Change\"])[2]")
	private WebElement ChangeTwo;
	
	public void setChangeOne() throws InterruptedException {
		waitForElementToAppearWithText(ChangeTwo, driver, "Change");
		ChangeOne.click();
	}
	
	public void setChangeTwo() throws InterruptedException {
		ChangeTwo.click();
	}
}
