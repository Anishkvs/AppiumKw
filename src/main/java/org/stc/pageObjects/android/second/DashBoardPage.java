...
public class DashBoardPage extends AndroidActions {
	...
	public void setAllow() throws InterruptedException {
		waitForElementToAppearWithText(allow, driver, "Allow");
		allow.click();
	}
	...
	public void setNotNowAll() throws InterruptedException {
		Thread.sleep(10000);
		driver.findElement(By.xpath("//android.widget.TextView[@text=\"Not Now\"] | //android.widget.TextView[@text=\"No, I will do it later\"] | //android.widget.TextView[@text=\"Update Now\"]"));
	}
	...
	private WebElement PayBillText;
	...
	public void setPayAdvance() {
		waitForElementToAppearWithText(PayBillText, driver, "Pay Bill");
		PayAdvance.click();
	}
	...
	public void getScrollKuwait() throws InterruptedException, IOException {
		System.out.println("TC_12: Scroll to Your Usage");
		scrollActionTwo("down");
		scrollActionTwo("down");
		Thread.sleep(1000);
	...
	public void getViewAll() throws InterruptedException {
		System.out.println("Search ViewAll");
		viewAll.click();
		Thread.sleep(1000);
	}
	...
	public void setManageAllSubscriptions() {
		System.out.println("TC_14: Scroll to 'Your Package'");
		scrollText("Your Package");
	...
	public void setAddOns() {
		System.out.println("TC_16: Swipe to Add-Ons");
	...
	public void setRoamingDestinationsUk() throws InterruptedException {
		System.out.println("TC_19: Scroll to Roaming Destination");
	...
	public void setRoamingDestinations() throws InterruptedException {
		System.out.println("Scroll to Roaming Destination");
		RoamingDestinationsUk.click();
		Thread.sleep(2000);
		//waitForElementToAppearWithText(LoginRoaming, driver, "Login to Subscribe");
	}
	...
	public void setCustomAmount(String value) throws InterruptedException {
		Thread.sleep(2000);
		CustomAmount.click();
		Thread.sleep(3000);
		CustomAmount.sendKeys(value);
		Proceed.click();
	}
	...
	@AndroidFindBy(accessibility = "Enable")
